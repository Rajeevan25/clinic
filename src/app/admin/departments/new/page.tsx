    ...
    try {
      const { error } = await supabase
        ...
        .insert({
          ...
          head_doctor_id: formData.head_doctor_id === 'none' || !formData.head_doctor_id ? null : formData.head_doctor_id,
    ...
    <div className="p-0">
      <div className="mb-8 pl-1">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
               <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Add New Department</h1>
               <p className="text-slate-500 font-medium">Create a new specialized medical unit.</p>
             </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden">
                <CardHeader className="bg-white border-b border-slate-50 px-8 py-6">
                  ...
                  <CardDescription>Enter the core details for this department.</CardDescription>
                </CardHeader>
          ...
          <div className="space-y-6">
            <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden sticky top-8">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="rounded-2xl border-2 border-dashed border-slate-200 aspect-video overflow-hidden bg-slate-50 flex items-center justify-center group relative">
                  {formData.image_url ? (
                    <>
                      <img 
